...
export default function Copyright() {
  ...
  return (
    <div className="mx-auto my-5 flex max-w-285 items-center justify-center gap-5 max-sm:flex-col max-sm:text-center">
      <p className="relative text-[#727070] after:absolute after:top-1/2 after:-right-3 after:h-4 after:w-0.5 after:-translate-y-1/2 after:bg-gray-500/50 last:after:hidden max-sm:after:hidden">
