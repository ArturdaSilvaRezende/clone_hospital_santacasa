...
export default function SchedulingDetails() {
  ...
  return (
    <div
      className="container mx-auto flex max-w-285 flex-col items-center p-4"
      ...
      >
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <dd className="text-[1rem] font-medium text-[#555353]">
              {content.data_nascimento
                ? new Date(content.data_nascimento).toLocaleDateString('pt-BR')
                : '---'}
            </dd>
          </div>
        ...
        <footer className="mt-12 w-full border-t pt-8 text-[#555353]">
          ...
          <ul className="flex list-inside list-disc flex-col gap-y-2">
            <li>
              Acompanhe seu agendamento, ele mudará a situação para{' '}
            ...
            <li>
              ...
              <a
                href="tel:6232544200"
                className="underline hover:text-blue-700 focus:outline-2 focus:outline-offset-2 focus:outline-dotted"
              >
                (62) 3254-4200
              </a>
            </li>
