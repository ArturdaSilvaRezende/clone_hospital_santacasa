...
export default function OurMission() {
  ...
  return (
    <section
      ...
      aria-labelledby={`${id}-our-mission`}
    >
      <div className="container mx-auto grid grid-cols-1 items-center gap-8 md:grid-cols-1 xl:grid-cols-12 max-sm:px-6 md:px-8 lg:px-8 xl:px-0">
        <div className="xl:col-span-4">
          ...
          <h2 className="flex flex-col text-[26px] max-sm:flex-row md:flex-row lg:flex-row xl:flex-col leading-tight font-medium text-[#FD0003]" id={`${id}-our-mission`}>
