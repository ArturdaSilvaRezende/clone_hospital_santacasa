...
export function Banner() {
  return (
    <div className="container mx-auto flex max-w-285 flex-col items-center justify-center py-20 text-center">
      ...
      <p className="w-249 text-[16px] font-medium text-[#727070]">
