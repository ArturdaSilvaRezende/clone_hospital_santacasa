...
export default function WhyDonate() {
  ...
  return (
    <section
      ...
      aria-labelledby="Critérios básicos para doação de sangue"
    >
      <div className="container mx-auto">
        ...
        >
          {criteria.map(item => (
            <li
              key={item.id}
              className="flex min-h-27 flex-col items-start rounded-xl bg-white py-4 px-5 text-left shadow-sm transition-shadow hover:shadow-md"
            >
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-red-600 mb-2">
                <Image
