...
export function FirstStep() {
  const { return_type: returnType, current_step: currentStep } = useSelector(
  ...
  function handleChangeReturnType(type) {
    console.log(type)
    dispatch(changeReturnType(type))
  }
  ...
  return (
    <div className="mt-8 flex w-full flex-col xl:mt-0">
      ...
      <div className="mt-4 flex flex-col md:flex-row lg:flex-row justify-center gap-x-4 gap-y-8 xl:mt-12 xl:flex-row xl:gap-x-8 xl:gap-y-0">
        ...
        <div
          onClick={() => handleChangeReturnType('return_post_hospitalization')}
          className="flex cursor-pointer flex-col items-center gap-y-2 text-center xl:text-start"
        >
          <div
        ...
        <div
          onClick={() => handleChangeReturnType('internal_routing')}
          className="flex cursor-pointer flex-col items-center gap-y-2 text-center xl:text-start"
        >
          <div
