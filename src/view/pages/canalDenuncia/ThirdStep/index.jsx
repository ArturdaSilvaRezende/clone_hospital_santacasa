...
export function ThirdStep() {
  ...
  const onSubmit = data => {
    ...
    const witnessesData = data?.witnesses || []
  ...
  return (
    <section
      className="mb-16 bg-white py-16 max-sm:py-10 md:py-10 lg:py-16"
    ...
    >
      <div className="container mx-auto space-y-4 max-sm:px-6 md:px-8 xl:px-0">
        ...
        <div className="my-10">
          <p className="border-b-2 border-black pb-5 text-[16px] font-bold">
          ...
          <div className="flex flex-col gap-y-5">
            ...
            <div className="flex flex-col gap-y-2">
              <label className="text-[14px] font-bold text-black md:w-[80%] lg:w-full">
                Há algum responsável ciente sobre o assunto? Se sim, informe o
                nome do responsável
                <span className="ml-2 text-[14px] font-normal text-[#727070]">
                  ( Opcional )
                </span>
